...
// IL2ERC721BridgeMetaData contains all meta data concerning the IL2ERC721Bridge contract.
var IL2ERC721BridgeMetaData = bind.MetaData{
...
// IL2ERC721Bridge is an auto generated Go binding around an Ethereum contract.
type IL2ERC721Bridge struct {
	abi abi.ABI
}

// NewIL2ERC721Bridge creates a new instance of IL2ERC721Bridge.
func NewIL2ERC721Bridge() *IL2ERC721Bridge {
	parsed, err := IL2ERC721BridgeMetaData.ParseABI()
	if err != nil {
		panic(errors.New("invalid ABI: " + err.Error()))
	}
	return &IL2ERC721Bridge{abi: *parsed}
}

// Instance creates a wrapper for a deployed contract instance at the given address.
// Use this to create the instance object passed to abigen v2 library functions Call, Transact, etc.
func (c *IL2ERC721Bridge) Instance(backend bind.ContractBackend, addr common.Address) *bind.BoundContract {
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackMESSENGER() []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("MESSENGER")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function MESSENGER() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackMESSENGER() ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("MESSENGER")
}
...
//
// Solidity: function MESSENGER() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackMESSENGER(data []byte) (common.Address, error) {
	out, err := iL2ERC721Bridge.abi.Unpack("MESSENGER", data)
	if err != nil {
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackOTHERBRIDGE() []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("OTHER_BRIDGE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function OTHER_BRIDGE() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackOTHERBRIDGE() ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("OTHER_BRIDGE")
}
...
//
// Solidity: function OTHER_BRIDGE() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackOTHERBRIDGE(data []byte) (common.Address, error) {
	out, err := iL2ERC721Bridge.abi.Unpack("OTHER_BRIDGE", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackBridgeERC721(localToken common.Address, remoteToken common.Address, tokenId *big.Int, minGasLimit uint32, extraData []byte) []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("bridgeERC721", localToken, remoteToken, tokenId, minGasLimit, extraData)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function bridgeERC721(address _localToken, address _remoteToken, uint256 _tokenId, uint32 _minGasLimit, bytes _extraData) returns()
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackBridgeERC721(localToken common.Address, remoteToken common.Address, tokenId *big.Int, minGasLimit uint32, extraData []byte) ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("bridgeERC721", localToken, remoteToken, tokenId, minGasLimit, extraData)
}
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackBridgeERC721To(localToken common.Address, remoteToken common.Address, to common.Address, tokenId *big.Int, minGasLimit uint32, extraData []byte) []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("bridgeERC721To", localToken, remoteToken, to, tokenId, minGasLimit, extraData)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function bridgeERC721To(address _localToken, address _remoteToken, address _to, uint256 _tokenId, uint32 _minGasLimit, bytes _extraData) returns()
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackBridgeERC721To(localToken common.Address, remoteToken common.Address, to common.Address, tokenId *big.Int, minGasLimit uint32, extraData []byte) ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("bridgeERC721To", localToken, remoteToken, to, tokenId, minGasLimit, extraData)
}
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackFinalizeBridgeERC721(localToken common.Address, remoteToken common.Address, from common.Address, to common.Address, tokenId *big.Int, extraData []byte) []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("finalizeBridgeERC721", localToken, remoteToken, from, to, tokenId, extraData)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function finalizeBridgeERC721(address _localToken, address _remoteToken, address _from, address _to, uint256 _tokenId, bytes _extraData) returns()
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackFinalizeBridgeERC721(localToken common.Address, remoteToken common.Address, from common.Address, to common.Address, tokenId *big.Int, extraData []byte) ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("finalizeBridgeERC721", localToken, remoteToken, from, to, tokenId, extraData)
}
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackOtherBridge() []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("otherBridge")
	if err != nil {
		panic(err)
	}
	return enc
...
// Solidity: function otherBridge() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackOtherBridge() ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("otherBridge")
}
...
// Solidity: function otherBridge() view returns(address)
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackOtherBridge(data []byte) (common.Address, error) {
	out, err := iL2ERC721Bridge.abi.Unpack("otherBridge", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
func (iL2ERC721Bridge *IL2ERC721Bridge) PackVersion() []byte {
	enc, err := iL2ERC721Bridge.abi.Pack("version")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function version() view returns(string)
func (iL2ERC721Bridge *IL2ERC721Bridge) TryPackVersion() ([]byte, error) {
	return iL2ERC721Bridge.abi.Pack("version")
}
...
//
// Solidity: function version() view returns(string)
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackVersion(data []byte) (string, error) {
	out, err := iL2ERC721Bridge.abi.Unpack("version", data)
	if err != nil {
...
// IL2ERC721BridgeERC721BridgeFinalized represents a ERC721BridgeFinalized event raised by the IL2ERC721Bridge contract.
type IL2ERC721BridgeERC721BridgeFinalized struct {
...
const IL2ERC721BridgeERC721BridgeFinalizedEventName = "ERC721BridgeFinalized"

// ContractEventName returns the user-defined event name.
func (IL2ERC721BridgeERC721BridgeFinalized) ContractEventName() string {
	return IL2ERC721BridgeERC721BridgeFinalizedEventName
}
...
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackERC721BridgeFinalizedEvent(log *types.Log) (*IL2ERC721BridgeERC721BridgeFinalized, error) {
	event := "ERC721BridgeFinalized"
	if len(log.Topics) == 0 || log.Topics[0] != iL2ERC721Bridge.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IL2ERC721BridgeERC721BridgeFinalized)
	if len(log.Data) > 0 {
		if err := iL2ERC721Bridge.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
	}
	var indexed abi.Arguments
	for _, arg := range iL2ERC721Bridge.abi.Events[event].Inputs {
		if arg.Indexed {
...
// IL2ERC721BridgeERC721BridgeInitiated represents a ERC721BridgeInitiated event raised by the IL2ERC721Bridge contract.
type IL2ERC721BridgeERC721BridgeInitiated struct {
	LocalToken  common.Address
	RemoteToken common.Address
	From        common.Address
	To          common.Address
...
const IL2ERC721BridgeERC721BridgeInitiatedEventName = "ERC721BridgeInitiated"

// ContractEventName returns the user-defined event name.
func (IL2ERC721BridgeERC721BridgeInitiated) ContractEventName() string {
	return IL2ERC721BridgeERC721BridgeInitiatedEventName
}
...
func (iL2ERC721Bridge *IL2ERC721Bridge) UnpackERC721BridgeInitiatedEvent(log *types.Log) (*IL2ERC721BridgeERC721BridgeInitiated, error) {
	event := "ERC721BridgeInitiated"
	if len(log.Topics) == 0 || log.Topics[0] != iL2ERC721Bridge.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IL2ERC721BridgeERC721BridgeInitiated)
	if len(log.Data) > 0 {
		if err := iL2ERC721Bridge.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
